...
[L_HD] = LAYOUT(
  ...
  // PQ TODO: use HD_xx?
  // config layer from default xbows nature keymap.c,
  // with some edits to add keys for testing string sending and macros
  [L_CFG] = LAYOUT(
    QK_BOOT,   _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  KC_CALC,   KC_MYCM,  KC_MSEL,   KC_MAIL,   NK_TOGG,   EE_CLR,
    _______,   PQ_SEND_STR_CAPI_1,  PQ_SEND_STR_CAPI_2,  PQ_SEND_MACRO_1,   _______,  _______,             _______,  _______,  _______,   _______,  _______,   _______,   _______,   KC_NUM,
//  _______,   _______,  _______,  _______,  _______,  _______,             _______,  _______,  _______,   _______,  _______,   _______,   _______,   KC_NUM,
    RM_TOGG,   RM_NEXT,  RM_VALU,  RM_HUEU,  _______,  _______,   _______,  _______,  _______,  _______,   _______,  _______,   _______,   _______,   KC_HOME,
    _______,   RM_SPDD,  RM_VALD,  RM_SPDU,  _______,  _______,   _______,  _______,  _______,  _______,   _______,  _______,   _______,   _______,   KC_END,
    _______, DF(L_QWERTY), DF(L_HD), CG_SWAP,CG_NORM,  _______,   _______,  _______,  _______,  _______,   _______,  _______,   KC_MUTE,   KC_VOLU,
