...
#define CA_SHBS MT(MOD_LSFT, KC_BSPC)
#define CA_SHQU MT(MOD_RSFT, KC_QUOTE)
#define CA_MTAZ MT(MOD_LALT, KC_Z)
#define CA_MTASC MT(MOD_RALT, KC_SCLN)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [DEF] = LAYOUT(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
        CW_TOGG, KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_QUOT, KC_BSLS,
        CA_SHBS, KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    CA_SHQU,
        KC_LGUI, CA_MTAZ, KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  CA_MTASC, KC_RCTL,
