...
[L_HD] = LAYOUT(
    HD_LT4, HD_LT3, HD_LT2, HD_LT1, HD_LT0, LT(L_CFG,KC_MUTE),  LT(L_CFG,KC_MPLY), HD_RT0, HD_RT1, HD_RT2, HD_RT3, HD_RT4,
    HD_LM4, HD_LM3, HD_LM2, HD_LM1, HD_LM0, LT(L_NUM,KC_TAB),           TT(L_NAV), HD_RM0, HD_RM1, HD_RM2, HD_RM3, HD_RM4,
    HD_LB4, HD_LB3, HD_LB2, HD_LB1, HD_LB0, ____,                          ____,   HD_RB0, HD_RB1, HD_RB2, HD_RB3, HD_RB4,
    ____,   ____,   ____,   HD_LH2, HD_LH1,             ____,                      HD_RH1, HD_RH2, ____,   ____,   ____),
...
[L_CFG] = LAYOUT(
    ...
    QK_BOOT, AG_NORM, CG_NORM, KC_VOLD, KC_BRID, AG_NORM, CG_NORM, _no_, KC_MRWD, KC_MPLY, KC_MFFD, SK_ZOOMIN,
                    ...
                    ____, ____, ____, ____, TG(L_NUM),/*  ____, */     ____, ____, ____, ____, ____, ____)
};
