...
[L_QWERTY] = LAYOUT(
    ...
    KC_DOWN, KC_UP, KC_APP, LT(L_FUN,KC_BSPC), LT(L_NAV,KC_DEL), /* LT(L_FUN,SK_MHEN), */ LT(L_FUN,SK_HENK), LT(L_SYM,KC_SPC), LT(L_NAV,KC_ENT), LT(L_NUM,KC_TAB), KC_LEFT, KC_RGHT),
...
[L_SYM] = LAYOUT(
    LS_LT4, LS_LT3, LS_LT2, LS_LT1, LS_LT0, _______,   _______, LS_RT0, LS_RT1, LS_RT2, LS_RT3, LS_RT4,
    LS_LM4, LS_LM3, LS_LM2, LS_LM1, LS_LM0, _______,   _______, LS_RM0, LS_RM1, LS_RM2, LS_RM3, LS_RM4,
...
[L_FUN] = LAYOUT(
    LF_LT4, LF_LT3, LF_LT2, LF_LT1, LF_LT0, _______,   _______, LF_RT0, LF_RT1, LF_RT2, LF_RT3, LF_RT4,
    LF_LM4, LF_LM3, LF_LM2, LF_LM1, LF_LM0, _______,   _______, LF_RM0, LF_RM1, LF_RM2, LF_RM3, LF_RM4,
    LF_LB4, LF_LB3, LF_LB2, LF_LB1, LF_LB0, LF_LBA,    LF_RBA,  LF_RB0, LF_RB1, LF_RB2, LF_RB3, LF_RB4,
    LF_LH5, LF_LH4, LF_LH3, LF_LH2, LF_LH1, LF_LH0,  /*LF_RH0*/ LF_RH1, LF_RH2, LF_RH3, LF_RH4, LF_RH5),

[L_NUM] = LAYOUT(
    LN_LT4, LN_LT3, LN_LT2, LN_LT1, LN_LT0, _______,   _______, LN_RT0, LN_RT1, LN_RT2, LN_RT3, LN_RT4,
    LN_LM4, LN_LM3, LN_LM2, LN_LM1, LN_LM0, _______,   _______, LN_RM0, LN_RM1, LN_RM2, LN_RM3, LN_RM4,
    LN_LB4, LN_LB3, LN_LB2, LN_LB1, LN_LB0, LN_LBA,    LN_RBA,  LN_RB0, LN_RB1, LN_RB2, LN_RB3, LN_RB4,
    LN_LH5, LN_LH4, LN_LH3, LN_LH2, LN_LH1, LN_LH0,  /*LN_RH0*/ LN_RH1, LN_RH2, LN_RH3, LN_RH4, LN_RH5),

[L_NAV] = LAYOUT(
    LV_LT4, LV_LT3, LV_LT2, LV_LT1, LV_LT0, _______,   _______, LV_RT0, LV_RT1, LV_RT2, LV_RT3, LV_RT4,
    LV_LM4, LV_LM3, LV_LM2, LV_LM1, LV_LM0, _______,   _______, LV_RM0, LV_RM1, LV_RM2, LV_RM3, LV_RM4,
    LV_LB4, LV_LB3, LV_LB2, LV_LB1, LV_LB0, LV_LBA,    LV_RBA,  LV_RB0, LV_RB1, LV_RB2, LV_RB3, LV_RB4,
    LV_LH5, LV_LH4, LV_LH3, LV_LH2, LV_LH1, LV_LH0,  /*LV_RH0*/ LV_RH1, LV_RH2, LV_RH3, LV_RH4, LV_RH5),


[L_CFG] = LAYOUT(
    LC_LT4, LC_LT3, LC_LT2, LC_LT1, LC_LT0, _______,   _______, LC_RT0, LC_RT1, LC_RT2, LC_RT3, LC_RT4,
    LC_LM4, LC_LM3, LC_LM2, LC_LM1, LC_LM0, _______,   _______, LC_RM0, LC_RM1, LC_RM2, LC_RM3, LC_RM4,
    LC_LB4, LC_LB3, LC_LB2, LC_LB1, LC_LB0, LC_LBA,    LC_RBA,  LC_RB0, LC_RB1, LC_RB2, LC_RB3, LC_RB4,
    LC_LH5, LC_LH4, LC_LH3, LC_LH2, LC_LH1, LC_LH0,  /*LC_RH0*/ LC_RH1, LC_RH2, LC_RH3, LC_RH4, LC_RH5),
};
