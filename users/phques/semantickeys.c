...
// Mac, Win, (Phase 3, add others if necessary, expand to multi-key?)
    ...
    [SK_ndx(SK_SCAP)] = {LSG(KC_4), S(G(KC_S))},          // Screen Capture
    ...
    [SK_ndx(SK_LINEBEG)] = {G(KC_LEFT),KC_HOME},          // Go to beg of line
    [SK_ndx(SK_LINEEND)] = {G(KC_RIGHT),KC_END},          // Go to end of line
    ...
    [SK_ndx(SK_ENYE)] = {A(KC_N),ALGR(KC_N)},             // ñ/Ñ
        // 'hard' mod keys, mainly for Cmd/Ctrl, to have these always be the same regardless of platform.
